          ...
          itemBuilder: (context, index) => ListTile(
            ...
            onTap: () {
              final result = SearchResult(
                cancel: false, 
                manual: false,
                position: LatLng(places[index].center[1], places[index].center[0]),
                name: places[index].text,
                description: places[index].placeName
              );

              searchBloc.add( OnAddToHistoryEvent(places[index]) );
    ...
    return ListView(
      children: [
        ...
        ListTile(
          ...
          title: const Text('Colocar un dirección manualmente', style: TextStyle(color: Colors.black)),
          onTap: () {
